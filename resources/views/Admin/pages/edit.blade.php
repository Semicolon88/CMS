                ...
                <div class="card-body">
                  {!! Form::open(['route' => ['pages.update',$page->id], 'method' => 'put']) !!}
                    ...
                    <div class="form-group @if($errors->has('title')) has-error @endif">
                        {!! Form::label('Title') !!}
                        {!! Form::text('title',$page->title,['class' =>'form-control','placeholder' => 'Post Title']) !!}
                        @if ($errors->has('title'))
                    ...
                    <div class="form-group @if($errors->has('publish')) has-error @endif">
                        {!! Form::label('Publish') !!}
                        {!! Form::text('publish',$page->is_published,['class' =>'form-control','placeholder' => 'Publish']) !!}
                    ...
                    <div class="form-group @if($errors->has('publish')) has-error @endif">
                        {!! Form::label('Details') !!}
                        {!! Form::textarea('details',$page->details,['class' =>'form-control','placeholder' => 'Post details']) !!}
                    ...
                    <div class="form-group @if($errors->has('post_type')) has-error @endif">
                        ...
                        {!! Form::text('post_type',$page->post_type,['class' =>'form-control','placeholder' => 'Post Type']) !!}
